...
def get_rest_info():
    ...
    crawling_list = page_soup.find_all(class_="listing")[:100]
...
def insert_data():
    ...
    for rest in restaurants:
        insert_statement = '''
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        '''
        values = (None, rest.name, rest.rating1, rest.reviews, rest.price, rest.url, rest.street, rest.city, rest.state, rest.zip)
